...
window.PORTAL = {
  ...
  calendarEvents: [
    ...
    { date: '2026-08-17', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/261928681379473', cohort: 'K1', title: 'K1 Coffee morning', sub: 'Information session' },
    ...
    { date: '2026-08-18', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/261940160950454', cohort: 'Y1', title: 'Y1 Coffee morning', sub: 'Information session' },
    { date: '2026-08-19', cat: 'event', type: 'gold', aud: 'child', nopage: true, title: 'K1 first day of school', sub: '' },
    { date: '2026-08-20', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/261940913095460', cohort: 'Y3 to Y6', title: 'Y3 to Y6 Coffee morning', sub: 'Information session' },
    { date: '2026-08-21', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/261940118766462', cohort: 'Y2', title: 'Y2 Coffee morning', sub: 'Information session' },
    { date: '2026-08-24', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/261940122478457', cohort: 'K2', title: 'K2 Coffee morning', sub: 'Information session' },
    { date: '2026-08-25', cat: 'event', type: 'purple', aud: 'parent', href: 'coffee-mornings/', ext: 'https://form.jotform.com/262158847629471', cohort: 'Dove', title: 'Dove Coffee morning', sub: 'Information session' },
    { date: '2026-09-07', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    { date: '2026-09-17', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Safeguarding parent info session', sub: '' },
    ...
    { date: '2026-10-01', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'ISB parent info session', sub: '' },
    { date: '2026-10-02', cat: 'event', type: 'purple', aud: 'parent', title: 'Parent Teacher Conferences (Progress)', sub: 'No school for children' },
    { date: '2026-10-05', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    { date: '2026-10-08', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Digital Safety parent info session', sub: '' },
    ...
    { date: '2026-10-29', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Workshop: Emotional Regulation', sub: '' },
    { date: '2026-11-02', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    ...
    { date: '2027-01-14', cat: 'workshop', type: 'purple', aud: 'child', nopage: true, community: true, comunita: true, title: 'Puberty Workshop', sub: 'Y5 and Y6' },
    { date: '2027-01-18', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    { date: '2027-01-28', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Workshop: Supporting Behaviours', sub: '' },
    { date: '2027-02-01', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    { date: '2027-02-08', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Workshop: Making Learning Visible', sub: '' },
    ...
    { date: '2027-02-19', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Workshop: An Author\'s Workshop', sub: '' },
    ...
    { date: '2027-03-01', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    { date: '2027-03-04', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Atelier explorations and learning', sub: '' },
    { date: '2027-03-09', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Wycombe Abbey Head of School info session', sub: '' },
    { date: '2027-03-11', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Emergent reading skill development', sub: '' },
    { date: '2027-03-17', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Philosophy Circle with Y6', sub: '' },
    { date: '2027-03-19', cat: 'event', type: 'purple', aud: 'parent', title: 'Parent Teacher Conference (Progress)', sub: 'No school for children' },
    { date: '2027-03-22', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Compass Initiatives: transitions to K1', sub: 'Morning, Atrium' },
    { date: '2027-03-22', cat: 'event', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Y3 to Y6 Drama and Music Evening', sub: '' },
    { date: '2027-03-25', cat: 'event', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Y3 to Y6 Drama and Music Evening', sub: '' },
    { date: '2027-04-01', cat: 'event', type: 'purple', aud: 'child', nopage: true, title: 'ELC Songkran celebrations', sub: '' },
    { date: '2027-04-01', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'The Wonder of Y6', sub: '' },
    ...
    { date: '2027-05-03', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
    ...
    { date: '2027-05-13', cat: 'workshop', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Navigating the AI Terrain', sub: '' },
    ...
    { date: '2027-06-07', cat: 'social', type: 'purple', aud: 'parent', community: true, comunita: true, title: 'Parent Social Morning', sub: '' },
  ...
  peEvents: [
    ...
    { date: '2027-05-29', cat: 'event', type: 'purple', aud: 'parent', nopage: true, community: true, comunita: true, pe: 'thonglor', title: 'Art Auction', sub: 'Location TBD' },
